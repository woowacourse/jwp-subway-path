...
//
//    @Autowired
//    private LinePropertyRepository linePropertyRepository;
...
//                () -> assertThat(actual).anyMatch(sectionRow -> sectionRow.getUpBound().equals("푸우") &&
//                        sectionRow.getDownBound().equals("테오") && sectionRow.getDistance() == 1),
//                () -> assertThat(actual).anyMatch(sectionRow -> sectionRow.getUpBound().equals("테오") &&
//                        sectionRow.getDownBound().equals("제이온") && sectionRow.getDistance() == 2),
//                () -> assertThat(actual).anyMatch(sectionRow -> sectionRow.getUpBound().equals("제이온") &&
//                        sectionRow.getDownBound().equals("시카") && sectionRow.getDistance() == 3)
//        );
//    }
//
//    @Test
