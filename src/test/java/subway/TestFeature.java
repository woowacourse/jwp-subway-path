...
public class TestFeature {
    ...
    public static final Station STATION_서울대입구 = Station.of(1L, "서울대입구역");
    public static final Station STATION_봉천역 = Station.of(2L, "봉천역");
    public static final Station STATION_낙성대역 = Station.of(3L, "낙성대역");
    public static final Station STATION_사당역 = Station.of(4L, "사당역");
    public static final Station STATION_방배역 = Station.of(5L, "방배역");
    public static final Station STATION_교대역 = Station.of(6L, "교대역");
    public static final Station STATION_인천역 = Station.of(7L, "인천역");
    public static final Station STATION_동인천역 = Station.of(8L, "동인천역");
    ...
    public static final Section SECTION_봉천_서울대입구 = Section.of(1L, STATION_봉천역, STATION_서울대입구, 5);
    public static final Section SECTION_서울대입구_사당 = Section.of(2L, STATION_서울대입구, STATION_사당역, 7);
    public static final Section SECTION_방배_봉천 = Section.of(3L, STATION_방배역, STATION_봉천역, 8);
    public static final Section SECTION_인천_방배 = Section.of(4L, STATION_인천역, STATION_방배역, 3);
    public static final Section SECTION_사당_동인천 = Section.of(5L, STATION_사당역, STATION_동인천역, 4);
    public static final Section SECTION_사당_낙성 = Section.of(6L, STATION_사당역, STATION_낙성대역, 7);
}
