...
class RouteFindControllerTest {
    ...
    void 경로_조회_요청시_출발역과_도착역_사이의_거리를_응답한다() {
        // given
        final RouteFindRequest routeFindRequest = new RouteFindRequest(1L, 2L);

        // when
        final ResponseEntity<RouteFindResponse> result = routeFindController.findRoute(routeFindRequest);
