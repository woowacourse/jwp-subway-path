...
public class TestDomainData {
    ...
    private static List<Station> makeStations() {
        return List.of(
                ...
                new Station(12L, "충정로"), new Station(13L, "아현"), new Station(14L, "이대"), new Station(15L, "신촌"),
                new Station(16L, "홍대입구"), new Station(17L, "합정"), new Station(18L, "당산"), new Station(19L, "영등포구청"),
                new Station(20L, "문래"), new Station(21L, "대림")
        );
    }
    ...
    private static List<Section> makeSections(final List<Station> stations) {
        ...
        System.out.println(stationsOfLine2);
        stationsOfLine2.addAll(1, List.of(stations.get(11),stations.get(2)));
        stationsOfLine2.addAll(11, List.of(stations.get(9), stations.get(20)));
