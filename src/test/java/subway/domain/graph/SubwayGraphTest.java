...
class SubwayGraphTest {
    ...
    void getShortestPath1() {
        // when
        final double pathWeight = graph.getPathWeight(A, H);
        final List<Station> stations = graph.getPath(A, H);
    ...
    void getShortestPath2() {
        // when
        final double pathWeight = graph.getPathWeight(B, D);
        final List<Station> stations = graph.getPath(B, D);
    ...
    void getShortestPath3() {
        // when
        final double pathWeight = graph.getPathWeight(B, E);
        final List<Station> stations = graph.getPath(B, E);
    ...
    void getShortestPath4() {
        // when
        final double pathWeight = graph.getPathWeight(C, D);
        final List<Station> stations = graph.getPath(C, D);
    ...
    void getShortestPath5() {
        // when
        final double pathWeight = graph.getPathWeight(H, A);
        final List<Station> stations = graph.getPath(H, A);
    ...
    void getShortestPath6() {
        // when
        final double pathWeight = graph.getPathWeight(E, B);
        final List<Station> stations = graph.getPath(E, B);
