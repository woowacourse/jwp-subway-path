...
class PathInfoFinderTest {
    ...
    private final PathInfoFinder pathInfoFinder = new PathInfoFinder(new NormalFeeStrategy(), sections);
    ...
    @Test
    @DisplayName("최단 경로의 거리를 조회한다.")
    public void getDijkstraShortestPathDistance() {
        assertAll(
