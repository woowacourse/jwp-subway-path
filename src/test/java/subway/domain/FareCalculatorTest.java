...
class FareCalculatorTest {
    ...
    void calculate_under10_adult() {
        final int budget = FareCalculator.calculate(new Line("신분당선", "빨강", 100), 10, 19);
    ...
    void calculate_under_teenager() {
        final int budget = FareCalculator.calculate(new Line("신분당선", "빨강", 100), 10, 18);
    ...
    void calculate_under_child() {
        final int budget = FareCalculator.calculate(new Line("신분당선", "빨강", 100), 10, 12);
    ...
    void calculate_over10km_adult() {
        final int budget = FareCalculator.calculate(new Line("신분당선", "빨강", 100), 31, 19);
    ...
    void calculate_over10km_teenager() {
        final int budget = FareCalculator.calculate(new Line("신분당선", "빨강", 100), 31, 18);
    ...
    void calculate_over10km_child() {
        final int budget = FareCalculator.calculate(new Line("신분당선", "빨강", 100), 31, 12);
    ...
    void calculate_over50km_adult() {
        final int budget = FareCalculator.calculate(new Line("신분당선", "빨강", 100), 59, 19);
    ...
    void calculate_over50km_teeenager() {
        final int budget = FareCalculator.calculate(new Line("신분당선", "빨강", 100), 59, 18);
    ...
    void calculate_over50km_child() {
        final int budget = FareCalculator.calculate(new Line("신분당선", "빨강", 100), 59, 12);
        Assertions.assertThat(budget).isEqualTo(1350);
    }
}
