...
//        // given
//        final SubwayMap subwayMap1 = new SubwayMap(new HashMap<>(Fixture.subwayMap.getSubwayMap()), new HashMap<>(Fixture.subwayMap.getEndpointMap()));
//
...
//
//        sectionList.forEach(s -> System.out.println(s.getDeparture().getName() + s.getArrival().getName()));
//
