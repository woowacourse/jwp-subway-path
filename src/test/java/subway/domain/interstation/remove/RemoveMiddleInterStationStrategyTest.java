...
class RemoveMiddleInterStationStrategyTest {
    ...
    class 중간에_제거가_가능한지_확인하는_기능_테스트 {
        ...
        void 제거할_수_있는지_검사한다(final long input, final boolean expected) {
            //given
            final RemoveInterStationStrategy removeInterStationStrategy = new RemoveMiddleInterStationStrategy();

            //when
            final boolean result = removeInterStationStrategy.isSatisfied(interStations, input);
