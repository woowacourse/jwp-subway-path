...
class AddMiddleInterStationStrategyTest {
    ...
    class 중간에_추가되는게_맞는지_검사하는_기능_테스트 {
        ...
        void 중간에_추가되는_경우() {
            ...
            final AddInterStationStrategy addInterStationStrategy = new AddMiddleInterStationStrategy();

            // when
            final boolean result = addInterStationStrategy.isSatisfied(interStations, upStationId, downStationId,
                    newStationId);
