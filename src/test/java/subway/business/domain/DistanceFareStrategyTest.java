...
import subway.config.DistanceFareStrategyConfig;

import static org.assertj.core.api.AssertionsForClassTypes.assertThat;

@ExtendWith({SpringExtension.class})
@ContextConfiguration(classes = DistanceFareStrategyConfig.class)
public class DistanceFareStrategyTest {
    ...
    void shouldCalculateFareWhenInputLessThan10Km(int distance, int expectedFare) {
        assertThat(distanceFareStrategy.calculateFare(distance)).isEqualTo(expectedFare);
    }
