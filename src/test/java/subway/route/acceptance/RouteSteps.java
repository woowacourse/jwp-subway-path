...
class RouteSteps {
    ...
    public static void 경로_확인(ExtractableResponse<Response> 역_거리_계산_요청_결과, InterStationEdge... 경로들) {
        assertThat(역_거리_계산_요청_결과.as(RouteFindResponse.class).getStations()).usingRecursiveComparison()
                .isEqualTo(Arrays.asList(경로들));
    }

    public static InterStationEdge 경로_하나_만들기(Long 시작_역_id, Long 끝_역_id, Long 거리, Long 노선_id) {
        return new InterStationEdge(시작_역_id, 끝_역_id, 거리, 노선_id);
    }
