...
class LineIntegrationTest extends IntegrationTest {
    ...
    public void setUp() {
        ...
        lineCreateRequest1 = new LineCreateRequest("신분당선", "bg-red-600");
        lineCreateRequest2 = new LineCreateRequest("구신분당선", "bg-red-600");
        lineUpdateRequest = new LineUpdateRequest("구신분당선", "bg-red-600");
    }
