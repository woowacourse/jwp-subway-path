...
public class LineIntegrationTest extends IntegrationTest {
    ...
    public void setUp() {
        ...
        lineRequest2 = new LineRequest("구신분당선", "bg-blue-600");
    }
    ...
    void getLines() {
        ...
        List<Long> resultLineIds = response.jsonPath().getList(".", LineSectionResponse.class).stream()
                .map(LineSectionResponse::getId)
                .collect(Collectors.toList());
    ...
    void getLine() {
        ...
        // then
        assertThat(response.statusCode()).isEqualTo(HttpStatus.OK.value());
        LineSectionResponse resultResponse = response.as(LineSectionResponse.class);
