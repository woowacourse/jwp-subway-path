...
public class LineIntegrationTest extends IntegrationTest {
    ...
    @DisplayName("지하철 노선 요청 검증 - 이름이 없는 경우")
    @Test
    void createLineWithEmptyName() {
        // given
        final LineRequest lineRequest = new LineRequest("", "테스트색");
        ...
        // then
        assertThat(response.statusCode()).isEqualTo(HttpStatus.BAD_REQUEST.value());
        assertThat(response.body().asString()).contains("[NotBlank] lineRequest name must not be blank");
    }
    
    @DisplayName("지하철 노선 요청 검증 - 역 색상이 없는 경우")
    @Test
    void createLineWithEmptyColor() {
        // given
        final LineRequest lineRequest = new LineRequest("신분당선", "");
        ...
        // then
        assertThat(response.statusCode()).isEqualTo(HttpStatus.BAD_REQUEST.value());
        assertThat(response.body().asString()).contains("[NotBlank] lineRequest color must not be blank");
    }
    ...
    public void setUp() {
        ...
        this.lineRequest1 = new LineRequest("신분당선", "테스트색");
        this.lineRequest2 = new LineRequest("구신분당선", "테스트색");
    }
}
