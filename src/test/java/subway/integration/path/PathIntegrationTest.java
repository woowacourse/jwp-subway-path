...
public class PathIntegrationTest extends IntegrationTest {
    ...
    void 최단경로를_조회한다() {
        // given
        final ExtractableResponse<Response> createResponse1 = 노선_생성_요청(new LineRequest("2호선", "서초역", "교대역", 7));
        ...
        final ExtractableResponse<Response> createResponse2 = 노선_생성_요청(new LineRequest("3호선", "신사역", "잠원역", 15));
        ...
        final ExtractableResponse<Response> createResponse3 = 노선_생성_요청(new LineRequest("9호선", "고속터미널역", "사평역", 8));
        ...
        final ExtractableResponse<Response> createResponse4 = 노선_생성_요청(new LineRequest("신분당선", "신사역", "논현역", 7));
