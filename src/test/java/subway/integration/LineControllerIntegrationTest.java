...
//                        List.of(
//                                new SectionQueryResponse("말랑역", 5),
//                                new SectionQueryResponse("오리역", 2),
//                                new SectionQueryResponse("찰리역", 3),
//                                new SectionQueryResponse("카프카역", 2),
//                                new SectionQueryResponse("미역", 0)
//                        )));
//        // when
...
//                .extracting(SectionQueryResponse::getStationName)
...
//                                List.of(
//                                        new SectionQueryResponse("말랑역", 3),
//                                        new SectionQueryResponse("오리역", 0))),
//                        new LineQueryResponse("2호선",
//                                List.of(
//                                        new SectionQueryResponse("찰리역", 5),
//                                        new SectionQueryResponse("카프카역", 0)))
//                ));
//        // when
//        final ExtractableResponse<Response> response = given().log().all()
//                .when()
