...
public class IntegrationTest {
    ...
    static Stream<Arguments> addSectionInvalidRequest() {
        return Stream.of(
            ...
            Arguments.of(new SectionAddRequest(1L, 0L, 2L, 1)),
            Arguments.of(new SectionAddRequest(1L, 1L, 0L, 1)),
            Arguments.of(new SectionAddRequest(1L, 1L, 2L, 0)),
            Arguments.of(new SectionAddRequest(2L, 1L, 2L, 1))
        );
    }
