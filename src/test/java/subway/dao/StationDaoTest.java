...
class StationDaoTest {
    ...
    class FindById {
        ...
        void findById() {
            ...
            final Optional<StationEntity> station = stationDao.findById(entity.getId());

            assertAll(
                    () -> assertThat(station.get().getId()).isEqualTo(entity.getId()),
                    () -> assertThat(station.get().getName()).isEqualTo(entity.getName())
            );
        }
