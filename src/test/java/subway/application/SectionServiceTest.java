...
class SectionServiceTest {
    ...
    @Test
    void deleteStation() {
        when(sectionDao.findByLineId(1L)).thenReturn(List.of(LINE1_SECTION_ST1_ST2, LINE1_SECTION_MIDDLE_ST2_ST3));
        when(stationDao.findById(1L)).thenReturn(Optional.of(FIXTURE_STATION_1));
        ...
        inOrder.verify(sectionDao).deleteByLineId(1L);
        inOrder.verify(sectionDao)
                .insertAllByLineId(1L, List.of(LINE1_SECTION_MIDDLE_ST2_ST3));
    }
