...
class PathControllerTest {
    ...
    void findShortestPathAndFare_메소드는_출발_역과_도착_역의_id를_전달하면_최단_경로와_요금을_반환한다()
        ...
        final PathSection pathSection = PathSection.of(first, second, line);
        final PathSections pathSections = PathSections.create();
        pathSections.add(pathSection);
        final ShortestPathsDto shortestPathsDto = ShortestPathsDto.from(List.of(pathSections));
