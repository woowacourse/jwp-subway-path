...
public class LineFixture {
    ...
    public static final Line LINE_NUMBER_THREE = new Line(2L, "3호선", new LinkedList<>(List.of(
            new MiddleSection(JAMSIL_STATION, JAMSIL_NARU_STATION, 10),
            new MiddleSection(JAMSIL_NARU_STATION, SULLEUNG_STATION, 97)
    )));
    public static final Line LINE_NUMBER_FOUR = new Line(3L, "4호선", new LinkedList<>(List.of(
