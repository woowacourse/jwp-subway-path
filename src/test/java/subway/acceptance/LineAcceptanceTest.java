...
public class LineAcceptanceTest extends AcceptanceTest {
    ...
    public class 노선을_추가할_때 {
        ...
        void 정상_요청의_경우_노선이_정상적으로_추가된다() {
            // given
            final var 요청_결과 = 노선_생성_요청("1호선", "파랑");
    ...
    public class 노선을_조회할_때 {
        ...
        void 노선_번호를_입력받아_상행종점역_부터_하행종점역으로_정렬된_결과를_반환한다() {
            // given
            final var 초록색_2호선 = 노선_생성_요청("2호선", "초록");
            ...
            노선_조회_결과를_확인한다(조회_결과, "2호선", "초록", "잠실", "잠실새내");
        }
    ...
    public class 노선을_전체_조회할_때 {
        ...
        void 상행종점역_부터_하행종점역으로_정렬된_결과를_반환한다() {
            ...
            노선_전체_조회_결과를_확인한다(
                    조회_결과,
                    노선_정보("2호선", "초록", "잠실", "잠실새내", "종합운동장"),
                    노선_정보("9호선", "고동", "봉은사", "종합운동장", "삼전")
            );
        }
    }
