...
public class LineAcceptanceTest extends IntegrationTest {
    ...
    class 노선을_추가할_때 {
        ...
        void 정상_요청의_경우_노선이_정상적으로_추가된다() {
            final var 요청_결과 = 노선_생성_요청("name", "color", 1L, 2L, 10L);
        ...
        void 역이_존재하지_않는_경우_예외가_발생한다() {
            final var 요청_결과 = 노선_생성_요청("name", "color", null, null, 10L);
        ...
        void 거리가_음수인_경우_예외가_발생한다() {
            final var 요청_결과 = 노선_생성_요청("name", "color", 1L, 2L, -1L);
    ...
    class 노선을_삭제할_때 {
        ...
        void 정상_요청의_경우_노선이_정상적으로_삭제된다() {
            ...
            final var 요청_결과 = 노선_삭제_요청(노선_id);

            요청_결과의_상태를_검증한다(요청_결과, 정상_요청이지만_반환값_없음);

            final var 노선_목록_조회_결과_2 = 노선_목록_조회_요청();
    ...
    class 노선을_id를_통해서_조회할_때 {
        ...
        void 없는_역을_조회하면_예외가_발생한다() {
            final var 요청_결과 = 노선에서_id_조회_요청(1L);
