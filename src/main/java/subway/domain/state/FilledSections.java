...
import subway.domain.strategy.SectionStrategy;
import subway.domain.strategy.StrategyFactory;
...
public final class FilledSections implements SectionState {
	...
	public Result removeStation() {
		final SectionStrategy sectionsStrategy = strategyFactory.determineStrategyForRemove(sections);
