...
public class LineDetailService {
    ...
    public LineDetailResponse saveLine(final LineDetailRequest request) {
        ...
        final LineDetailEntity findLineDetailEntity = lineDetailDao.insert(new LineDetailEntity(request.getName(), request.getColor()));
        return LineDetailResponse.of(findLineDetailEntity);
    }
