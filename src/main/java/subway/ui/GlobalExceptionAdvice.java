...
public class GlobalExceptionAdvice {
    ...
    @ExceptionHandler({NoSuchLineException.class, NoSuchStationException.class, AlreadyExistLineException.class, AlreadyExistStationException.class, IllegalArgumentException.class, NotInitializedLineException.class})
